...
public class Retailwebscrapermain {
    public static final void main(String[] args) {
        ...
        //String inputurl = "https://www.sainsburys.co.uk/shop/gb/groceries/ripe---ready/sainsburys-conference-pears--ripe---ready-x4-%28minimum%29";
        ...
        try {
            ...
            //System.out.println(new JSONObject(scraper.webScaper((url)).toString(spacesToIndentEachLevel));
